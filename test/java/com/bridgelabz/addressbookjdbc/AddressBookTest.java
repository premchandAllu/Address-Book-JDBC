...
public class AddressBookTest {
	...
	public void givenNewSalaryForEmployee_WhenUpdatedUsingPreparedStatement_ShouldSyncWithDB() {
		AddressBookService addressBookService = new AddressBookService();
		List<Contact> contactList = addressBookService.readContactData();
		addressBookService.updateContactDetails("Prem", "Chennai");
		boolean result = addressBookService.checkContactInSyncWithDB("Prem");
	...
	public void givenNewContact_WhenAdded_ShouldSyncWithDB() {
		...
		addressBookService.addContactToDatabase("Arjun", "Reddy", "PTowers", "Bangalore", "Karnataka", 700012, 99084874,
				"arjunreddy@gmail.com", "Personal", "Family", date);
	...
	public void givenContacts_WhenAddedToDB_ShouldMatchEmployeeEntries() {
		Contact[] arrayOfEmployee = {
				new Contact("Kabir", "Singh", "Mumbai", "Mumbai", "Maharastra", 507012, 98654331,
						"kabirsingh@gmail.com", "Casual", LocalDate.now()),
				new Contact("Aditya", "varma", "parambakam", "chennai", "Tamilnadu", 500050, 96763129,
